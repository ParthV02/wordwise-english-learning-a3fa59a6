    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary/5 via-background to-secondary/5 px-4">
      <div className="w-full max-w-md space-y-8 fade-in">
        ...
        <div className="text-center">
          <div className="mx-auto mb-4 relative inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-primary shadow-lg">
            <BookOpen className="h-8 w-8 text-primary-foreground" />
            <Mic className="absolute -bottom-1 -right-1 h-5 w-5 rounded-full bg-secondary p-0.5 text-secondary-foreground shadow" />
          </div>
          <h1 className="text-3xl font-extrabold text-primary">WordWise</h1>
          <p className="mt-1 text-sm text-muted-foreground">Learn Smarter, Speak Clearer</p>
        </div>
        ...
        <div className="rounded-2xl bg-card p-8 shadow-lg border border-border">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 h-11 text-sm font-semibold">
              Sign In
            </Button>
          </form>
